...
from MediaCrawler.model.m_douyin import VideoUrlInfo, CreatorUrlInfo
from MediaCrawler.tools.crawler_util import extract_url_params_to_dict

douyin_sign_obj = execjs.compile(open('MediaCrawler/libs/douyin.js', encoding='utf-8-sig').read())
